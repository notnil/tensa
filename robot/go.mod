module github.com/notnil/tensa
...
require (
	...
	github.com/notnil/canbus v0.0.0-20250911233506-193d3be8e9f9
	github.com/notnil/modbus v0.0.0-20250509001744-72b2d16da23e
	github.com/notnil/rowboat v0.1.0
